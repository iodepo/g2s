...
from defs import etl_group_new
from defs import etl_jsonl
from defs import etl_query
# from defs import etl_query_multi
...
def main():
    ...
    group_parser.add_argument("--table", required=True, help="LanceDB Table name")
    ...
    augment_parser.add_argument("--sink", required=True, help="Output destination")
    augment_parser.add_argument("--table", required=True, help="LanceDB Table name")
    ...
    mode_handlers = {
        ...
        # "query": etl_query_multi.query_mode,
        # "group": etl_group.group_mode_orig,
        "group": etl_group_new.group_mode_new,
    ...
    if args.mode == "query":
        ...
        mode_handlers[args.mode](args.source, args.sink, args.table)
